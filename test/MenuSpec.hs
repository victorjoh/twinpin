    ...
    describe "updateSelection" $ do
        ...
        it
            ...
            $ let dirDown = toEvent $ JoyHatEventData 0 0 HatDown
              in  getSelection (updateSelection [dirDown] $ basicMenu 0)
                      `shouldBe` "b"
        it
            ...
            $ let dirUp = toEvent $ JoyHatEventData 0 0 HatUp
              in  getSelection (updateSelection [dirUp] $ basicMenu 1)
                      `shouldBe` "a"
        it
            ...
            $ let arrowDown = toEvent $ KeyboardEventData
              ...
              in  getSelection (updateSelection [arrowDown] $ basicMenu 0)
                      `shouldBe` "b"
        it
